...
var getHopBridge = function (_a) {
    var provider = _a.provider, tokenName = _a.token, tokenAmount = _a.tokenAmount, fromChainName = _a.fromChainName, toChainName = _a.toChainName, toAddressRaw = _a.toAddress, slippageTolerance = _a.slippageTolerance;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 5:
                    ...
                    isApprovalNeeded = function () { return __awaiter(void 0, void 0, void 0, function () {
...
export function useHopBridge(_a) {
    ...
    return useCallback(function () { return function (args) { return getHopBridge(__assign({ provider: provider }, args)); }; }, [provider]);
}
